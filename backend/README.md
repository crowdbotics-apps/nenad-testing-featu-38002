...
## Project Structure
    ...
    ├── nenad_testing_featu_38002  # Django project configurations
...
1. Clone this repo and `cd nenad_testing_featu_38002`
...
2. Clone this repo and `cd nenad_testing_featu_38002`
